...
public class Spreadsheet 
{
	...
	private void printRow(int row)
	{
		...
		for (int col = 0; col < COLS; col++)
		{
			String value = (data[row][col] == null) ? "" : getData()[row][col].getDisplayValue();
	...
	// is a getter method to get the value of a cell without calling the data variable
	public Cell[][] getData() {
		return data;
	}

	public void setData(int row, int col, Cell cell) { //is a setter method that is only used 
		// in the main method of expression simplifier to test expression simplifier methods
		data[row][col] = cell;
	}
