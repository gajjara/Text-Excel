...
/*
	...
	@Test
	public void TextExcelSortAReference()
	{
		String[] input =
			{
					"G10 = 100",
	...
	@Test
	public void TextExcelSortDReference()
	{
		String[] input =
			{
					"G10 = 100",
		...
		verify.that(getCell(response, 'A', 2)).matches(" 84\\.0 "); 
		verify.that(getCell(response, 'A', 3)).matches(" 76\\.0 "); 
		verify.that(getCell(response, 'A', 4)).matches(" 43\\.0 "); 
		verify.that(getCell(response, 'A', 5)).matches(" 15\\.0 "); 
	}
